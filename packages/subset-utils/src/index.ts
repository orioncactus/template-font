...
// == Constants ===============================================================
const STATIC_PATH = join(process.cwd(), "fonts", "ttf"); // 코멘트: otf만 둔다면 ttf를 otf로 바꾸기
...
export enum FONTFAMILY {
    TemplateFont = "TemplateFont", // 옵션: 다른 폰트 패키지를 추가한다면 다음 줄에 이름 바꾸기
}
...
// == Main ====================================================================
export function getFontList(family = FONTFAMILY.TemplateFont, options?: TFontListOptions) {
    const { ext = "ttf", variable = false } = options ?? {}; // 코멘트: otf만 둔다면 ttf를 otf로 바꾸기
